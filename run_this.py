...
def query_message(query, prevs, model, embeddings):
    ...
    return f"""
####
다음 단서들을 참조하여 {tone}하세요. 단서가 부족하면 '{unknown_}' 라고 답하고 없는 사실을 지어내지는 마세요. 답변은 {expertise} 전문가의 용어나 문체를 적극 활용하고, 공손한 말투를 사용해주세요.
